...
parser.add_argument('-hidden_size', type=int, default=100, help='The number of hidden nodes')
...
parser.add_argument('-train_data_path', type=str, default='0910_b_train.csv', help='Path to the training dataset')
parser.add_argument('-test_data_path', type=str, default='0910_b_test.csv', help='Path to the testing dataset')
